...
<div class="container-fluid p-4">
            ...
            <div class="col-6 col-lg-3 mx-auto">
                <div class="card">
                    ...
                    <div class="card-footer">
                        <a href="<?= base_url('user/menu/' . $fnb['id']); ?>" class="float-end btn btn-dark text-warning rounded-pill fw-bold">View
                            More</a>
                    </div>
                </div>
            </div>
    ...
    <div class="row">
        <div class="col d-flex justify-content-center">
            <a class="btn btn-warning rounded-pill text-dark fw-bold" href="<?= base_url('user/warung'); ?>">See More</a>
        </div>
    </div>
</div>
<!-- END FnB -->
        ...
        <?php foreach ($foods as $f) : ?>
            <div class="col-6 col-lg-3 mx-auto">
                <div class="card">
                    ...
                    <div class="card-footer">
                        <a href="<?= base_url('user/menu/' . $f['id']); ?>" class="float-end btn btn-dark text-warning rounded-pill fw-bold">View
                            More</a>
                    </div>
                </div>
            </div>
        ...
        <?php foreach ($beverages as $b) : ?>
            <div class="col-6 col-lg-3 mx-auto">
                <div class="card">
                    ...
                    <div class="card-footer">
                        <a href="<?= base_url('user/menu/' . $b['id']); ?>" class="float-end btn btn-dark text-warning rounded-pill fw-bold">View
                            More</a>
                    </div>
                </div>
            </div>
