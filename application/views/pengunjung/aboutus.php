...
<div class="container-fluid bg-dark mt-4">
    ...
    <div class="row d-flex justify-content-around">
        <div class="col-lg-4 d-flex flex-column align-items-center">
            ...
            <a href="https://instagram.com/azzhrfqhkm" target="_blank" rel="noopener noreferrer" class="text-warning fw-light link-ig mb-3">Instagram</a>
        </div>
        <div class="col-lg-4 d-flex flex-column align-items-center">
    ...
    <div class="row d-flex justify-content-around mt-3 mx-4 mb-4">
        <div class="col-lg-5 d-flex flex-column align-items-center">
            ...
            <p class="p-team text-light mt-0 mb-0">Sistem Informasi</p>
            <p class="p-team text-light fw-bold mb-0">UBSI TEGAL</p>
            <a href="https://instagram.com/kacangijo_01" target="_blank" rel="noopener noreferrer" class="text-warning fw-light link-ig mb-3">Instagram</a>
        </div>
        <div class="col-lg-5 d-flex flex-column align-items-center">
            ...
            <p class="p-team text-light mt-0 mb-0">Sistem Informasi</p>
            <p class="p-team text-light fw-bold mb-0">UBSI TEGAL</p>
            <a href="https://instagram.com/cindyas10" target="_blank" rel="noopener noreferrer" class="text-warning fw-light link-ig mb-3">Instagram</a>
        </div>
    </div>
</div>